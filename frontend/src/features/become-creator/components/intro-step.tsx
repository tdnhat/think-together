  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col items-center gap-4 text-center">
        <div className="flex h-24 w-24 items-center justify-center rounded-2xl border-4 border-border bg-secondary">
          <Sparkles className="h-12 w-12 text-foreground" strokeWidth={2} />
        </div>
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3 rounded-lg border-2 border-border bg-secondary/10 p-4">
          <Rocket className="h-6 w-6 shrink-0 text-foreground mt-1" strokeWidth={2} />
          <p className="text-base text-foreground font-sans font-medium">
