    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{ width: gapWidth } as React.CSSProperties}
        />
        <div
          className={cn(
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col p-2", isCollapsed && "p-0", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <ul
      ref={ref}
      data-sidebar="menu"
      className={cn("flex w-full min-w-0 flex-col gap-1", isCollapsed && "items-center", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <li
      ...
      className={cn("group/menu-item relative", isCollapsed && "flex justify-center", className)}
      {...props}
    />
  )
})
