...
function Sidebar({
  ...
  const isOffcanvasMode = collapsible === "offcanvas" && isCollapsed
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          isOffcanvasMode && "w-0",
          isIconMode && (variant === "floating" || variant === "inset"
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col p-2 border-b-2 border-b-border last:border-b-0 group-data-[state=collapsed]:p-1",
        className,
      )}
      {...props}
    />
...
function SidebarMenuSkeleton({
  ...
  // Random width would differ between server and client renders
