...
namespace ThinkTogether.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251122064401_UpdateShadowForeignKeys")]
    partial class UpdateShadowForeignKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThinkTogether.Domain.Aggregates.QuizSetAggregate.ValueObjects.QuestionOption", b =>
                {
                    b.Property<string>("Content")
                        .HasMaxLength(1000)
                    ...
                    b.HasKey("Content", "DisplayOrder");

                    b.HasIndex("QuestionId");

                    b.ToTable("CauHoi_TracNghiem", null, t =>
                        {
                            t.HasCheckConstraint("CK_CauHoi_TracNghiem_thuTu", "thuTu >= 0");
                        });
                });
