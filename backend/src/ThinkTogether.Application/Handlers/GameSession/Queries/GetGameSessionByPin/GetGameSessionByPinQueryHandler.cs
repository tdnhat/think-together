...
public sealed class GetGameSessionByPinQueryHandler : IRequestHandler<GetGameSessionByPinQuery, GameSessionDto>
{
    ...
    public GetGameSessionByPinQueryHandler(
    ...
    public async Task<GameSessionDto> Handle(GetGameSessionByPinQuery request, CancellationToken cancellationToken)
    {
        ...
        if (gameSession.Status == GameStatus.InProgress && gameSession.GameQuestions.Count > 0)
        {
